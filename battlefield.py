...
class Battlefield: 
    ...
    def select_robot_weapon(self): 
        user_input = int(input('Choose the robots weapon! Input 1 for axe, 2 for sword, 3 for a pillow, and 4 for BAZOOKA!'))
        ...
        if user_input == 1: 
            ...
            self.robot.active_weapon = Weapon('Bazooka', 1000) 
